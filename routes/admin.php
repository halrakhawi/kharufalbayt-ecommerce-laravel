...
Route::get('/subcategory/edit/{id}',[App\Http\Controllers\admin\CategoriesController::class,'editsub'])->name('admin.subcategories.edit');
Route::post('/subcategory/update/{id}',[App\Http\Controllers\admin\CategoriesController::class,'updatesub'])->name('admin.subcategories.update');
...
Route::get('/paymentmethods',[App\Http\Controllers\admin\SegmentaionController::class,'paymentmethodsindex'])->name('admin.paymentmethods.index');
Route::get('/paymentmethods/all',[App\Http\Controllers\admin\SegmentaionController::class,'allpaymentmethods'])->name('admin.paymentmethods.allmethods');
Route::post('/paymentmethods/active/{id}',[App\Http\Controllers\admin\SegmentaionController::class,'activepaymentmethod'])->name('admin.paymentmethods.active');
Route::get('/paymentmethods/edit/{id}',[App\Http\Controllers\admin\SegmentaionController::class,'editpaymentmethod'])->name('admin.paymentmethods.edit');
Route::post('/paymentmethods/update/{id}',[App\Http\Controllers\admin\SegmentaionController::class,'updatpaymentmethod'])->name('admin.paymentmethods.update');
Route::get('/paymentmethods/create',[App\Http\Controllers\admin\SegmentaionController::class,'createpaymentmethod'])->name('admin.paymentmethods.create');
Route::post('/paymentmethods/store',[App\Http\Controllers\admin\SegmentaionController::class,'storepaymentmethod'])->name('admin.paymentmethods.store');
