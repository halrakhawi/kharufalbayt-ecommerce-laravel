            ...
            <div class="auto-container">
                <div class="content-box">
                    ...
                    <ul class="bread-crumb clearfix">
                        ...
                        <li><a href="#" class="active">|كل المنتجات</a></li>
                    </ul>
                </div>
            </div>
        </section>
                        ...
                        <div class="inner-box">
                            <figure class="image-box">
                                ...
                                <ul class="list clearfix">
                                    ...
                                    <li><a href="{{route('showproductweb',$item->id)}}">الشراء الآن</a></li>
                                </ul>
                            </figure>
                            <div class="lower-content">
                                <h6><a href="{{route('showproductweb',$item->id)}}">{{$item->cat}}-{{$item->subcat}}-{{$item->name}}</a></h6>
