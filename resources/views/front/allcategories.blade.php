                    ...
                    <div class="shop-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box">
                                <img src="{{asset('assets/topcategories/'.$item->picture)}}" alt="" width="320px" height="320px">
                                <ul class="list clearfix">
                                    <!-- <li><a href=""><i class="flaticon-cart"></i></a></li> -->
                                    <li><a href="{{route('showcategorybyid',$item->id)}}">التفاصيل</a></li>
                                </ul>
                            </figure>
                            <div class="lower-content">
                                <h6><a href="{{route('showcategorybyid',$item->id)}}">{{$item->name}}</a></h6>
