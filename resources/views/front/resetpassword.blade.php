        ...
        <div class="col-md-6 col-12">
            <div class="divContentLOGIN">
                <div class="circleLogoSign">
                    <img class="ImgcircleLogoSign" src="{{asset('assets/front/images/logo1.png')}}" alt="" width="30%" height="30%">
                </div>
                    <label class="lblPhone" style="text-align: center;font-size: 20px;font-weight: bold">كود التحقق</label>                  
                <div id="LOGIN" class="contentTabs showTab">
                    <i class="fas fa-phone iconSign"></i>
                    <label class="lblPhone" style="text-align: center;font-size: 20px;font-weight: bold" >{{$code}}</label>                     
