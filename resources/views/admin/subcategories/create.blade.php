                            ...
                            <div class="card-body">
                                <div class="digital-add needs-validation">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="m-checkbox-inline mb-0 custom-radio-ml d-flex radio-animated">
                                            <label class="d-block" for="edo-ani">
                                                <input class="radio_animated" id="edo-ani" type="radio" name="flag" value="1">
                                                فعال
                                            </label>
                                            <label class="d-block" for="edo-ani1">
                                                <input class="radio_animated" id="edo-ani1" type="radio" name="flag" value="0">
                                                غير فعال
                                            </label>
                                        </div>
                                        @if($errors->has('flag'))
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="m-checkbox-inline mb-0 custom-radio-ml d-flex radio-animated">
                                            <label class="d-block" for="edo-ani">
                                                <input class="radio_animated" id="edo-ani" type="radio" name="options" value="1">
                                                فعال
                                            </label>
                                            <label class="d-block" for="edo-ani1">
                                                <input class="radio_animated" id="edo-ani1" type="radio" name="options" value="0">
                                                غير فعال
                                            </label>
                                        </div>
